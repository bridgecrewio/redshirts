...
export default class Bitbucket extends Command {
    ...
    static flags = {
        ...
        token: Flags.string({
            char: 't',
            description: 'A Bitbucket access token tied to the provided username. This token must be tied to a user that has sufficient visibility of the repo(s) being counted. See the description below for how to create this token.',
            required: true,
            helpGroup: HelpGroup.AUTH
        }),
